...
* [Phala Cloud](https://cloud.phala.com/register?invite=PHALAWIKI) API key
...
ℹ Open in Web UI at https://cloud.phala.com/dashboard/
```
...
│ App URL             │ https://cloud.phala.com/dashboard/cvms/app_ecc21474f89b47a8e33ecd4e53a0ed744fff4eb2           │
