...
<Frame caption="Private Docker registry configuration">
    <img src="/images/cloud-private-docker.png" alt="Private Docker registry configuration" />
...
**Using a Private Docker Registry with** [**Phala Cloud CLI**](/phala-cloud/phala-cloud-cli/overview)
...
├────────────┼────────────────────────────────────────────────────────────────────────────────────────────┤
│ App URL    │ https://cloud.phala.com/dashboard/cvms/app_9292e497bee0f6885df155c79635606c33b9c160    │
╰────────────┴────────────────────────────────────────────────────────────────────────────────────────────╯
ℹ 
